...
scene.onOverlapTile(SpriteKind.Player, sprites.castle.saplingOak, function (sprite9, location9) {
    mySprite.sayText("Sembla que si salto m'esperen grans recompenses.")
})
...
scene.onOverlapTile(SpriteKind.Player, sprites.builtin.brick, function (sprite, location) {
    ...
    game.showLongText("Més endavant està el castell de Sauron, on està la princesa raptada.", DialogLayout.Bottom)
    game.showLongText("El meu objectiu es salvar-la de les mans equivocades.", DialogLayout.Bottom)
...
scene.onOverlapTile(SpriteKind.Player, sprites.dungeon.collectibleBlueCrystal, function (sprite4, location4) {
    ...
    game.showLongText("Sembla que aquest passadís esta a punt de colapsar!", DialogLayout.Bottom)
    game.showLongText("He de marxar ràpid si viu sortir viu d'aquí!", DialogLayout.Bottom)
})
...
scene.onOverlapTile(SpriteKind.Player, sprites.builtin.oceanSand0, function (sprite6, location6) {
    mySprite.sayText("Sembla que no hi ha sortida, he de saltar.")
})
...
game.showLongText("Benvingut a...", DialogLayout.Center)
game.showLongText("Les magnífiques, emocionants, extrepidants i divertides...", DialogLayout.Center)
game.showLongText("Del nostre aventurer preferit, ALBERDOOM!", DialogLayout.Center)
game.showLongText("Començem!", DialogLayout.Center)
...
game.setDialogTextColor(2)
game.showLongText("Theoden", DialogLayout.Center)
